...
import signUpUtil from "./signup-backend";
...
export default class Home extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      modal3Visibility: "hidden",
    };

    this.signUpReset = function () {
      this.state.signUpOrgName = "";
      this.state.signUpOfficialId = "";
      this.state.signUpEmail = "";
      this.state.signUpWalletAddr = "";
      this.state.signUpUserId = "";
      this.state.isSignUpAvail = false;
    };
  }
  ...
  render() {
    return (
      <div>
            ...
            <ul className="nav__links">
              ...
              <li className="nav__item">
                <a
                  ...
                  href="#"
                  onClick={() => {
                    this.setState({ ...this.state, modal3Visibility: "" });
                  }}
                >
                  Sign Up
                </a>
        ...
        <div className={`modal ${this.state.modal3Visibility}`} id="modal--1">
          <button
            className="btn--close-modal"
            onClick={() => {
              this.setState({ ...this.state, modal3Visibility: "hidden" });
              this.signUpReset();
            }}
          >
            &times;
          ...
          <h2 className="modal__header">
            Fill and get your DAO registered <br />
            in just <span className="highlight">5 minutes</span>
          </h2>
          <form className="modal__form">
            <label>Organisation Name</label>
            <input
              type="text"
              value={this.state.signUpOrgName}
              onChange={(e) => {
                this.setState({ ...this.state, signUpOrgName: e.target.value });
              }}
            />
            <label>Wallet Address</label>
            <input
              type="text"
              value={this.state.signUpWalletAddr}
              onChange={(e) => {
                this.setState({
                  ...this.state,
                  signUpWalletAddr: e.target.value,
                });
              }}
            />
            ...
            <input
              type="text"
              value={this.state.signUpOfficialId}
              onChange={(e) => {
                this.setState({
                  ...this.state,
                  signUpOfficialId: e.target.value,
                });
              }}
            />
            ...
            <input
              ...
              onChange={(e) => {
                console.log(e.target.value);
                this.setState({ ...this.state, signUpEmail: e.target.value });
              }}
            />
            <button
              className="btn"
              onClick={() => {
                signUpUtil.register(this.state, (userId) => {
                  this.setState({
                    ...this.state,
                    signUpUserId: userId,
                    isSignUpAvail: true,
            ...
            {this.state.isSignUpAvail ? (
              <button hidden={this.state.isSignUpAvail} className="btn">
                {this.state.signUpUserId}
              </button>
            ) : (
              ""
